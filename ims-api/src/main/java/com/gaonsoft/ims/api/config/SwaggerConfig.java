package com.gaonsoft.ims.api.config;
...
public class SwaggerConfig {
	...
	public Docket petApi() {
		ApiInfo info = new ApiInfo("IMS Api", "Api document for issus management system", "v1", "localhost:8080",
...
//					.apis(RequestHandlerSelectors.any())
					.apis(RequestHandlerSelectors.basePackage("com.gaonsoft.ims.api.controller"))
